      ...
      <div className="mb-6">
        {orgName && (
          <div className="flex items-center gap-1.5 mb-2">
            ...
            {orgLogoUrl ? (
              <img src={orgLogoUrl} alt={orgName} className="h-4 w-auto max-w-[80px] object-contain opacity-75" />
            ) : (
            ...
            <span className="text-[11px] font-medium text-slate-400 truncate">{orgName}</span>
          </div>
        )}
